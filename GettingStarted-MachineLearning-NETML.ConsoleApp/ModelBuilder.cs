...
namespace GettingStarted_MachineLearning_NETML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\PersonalSites\GettingStarted-MachineLearning-NET\GettingStarted-MachineLearning-NET\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\arc\AppData\Local\Temp\MLVSTools\GettingStarted-MachineLearning-NETML\GettingStarted-MachineLearning-NETML.Model\MLModel.zip";
